		...
		<?php
			 while ($var_dato = $var_resultado->fetch_array()) { ?>
		    		...
		    		<tr>
						...
						<td><?php echo $var_dato['empresa']; ?></td>
						<td><?php echo $var_dato['id_conductor']; ?></td>
						<td>
							
						<input style="display:none;" type="text" name="id">
						<button class="btnedit" data-toggle="modal" data-target="#actualizarModal" value="actualizar.php?id=<?php echo $var_dato["id_bus"]; ?>"></button>
